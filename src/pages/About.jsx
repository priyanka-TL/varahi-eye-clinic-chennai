          ...
          <div className="about-grid">
            <div className="slide-up">
              ...
              <p className="p-large" style={{ marginBottom: '2rem' }}>
                As the name sounds pious and pure, this center offers quality care and patient centered services. This clinic also provides ethical, economical medical treatment for all ages, including specialized <strong style={{ color: 'var(--color-primary)', fontWeight: '600' }}>Pediatric Eye care</strong>, and surgical treatment related to cataract and glaucoma for adults and elderly by an expert ophthalmologist in the center of the city with good ambience and parking facility.
              </p>
